...
for i = 1:height(x) 
    x.velocinterp{i} = interp1(x.velocitytrials2{i}(2:end-1,1),x.velocitytrials2{i}(2:end-1,2),timei(:),'linear','extrap');
end 
